...
//  google map 2 function custom ========================== //
	...
	if(jQuery('#gmap_canvas2').length){
		function init_map2() {
			var myOptions = {
				zoom: 10,
				center: new google.maps.LatLng(19.1137666, -104.3221104),
			...
			marker2 = new google.maps.Marker({
				map: map2,
				position: new google.maps.LatLng(19.1137666, -104.3221104),
				optimized: false,
			...
			infowindow2 = new google.maps.InfoWindow({
				content: '<strong>Title</strong><br>Av. Elías Zamora Verduzco #2124-F Planta Alta, Manzanillo, Colima, México, C.P. 28869.<br>'
			});
